---
  title: Dotfiles
  summary: My personal backup of my dotfiles, featuring i3-wm, rofi, polybar, and more.
  image: /images/dotfiles.png
  role: 'Author'
  publishedAt: '2024-09-21'
  projectUrl: 'https://github.com/berthosefin/dotfiles'
  liveUrl:
  tags: ['i3-wm', 'Linux', 'Rofi', 'Polybar', 'Alacritty']
---
...
`git`, `stow`, `i3-wm`, `i3lock-color`, `feh`, `polybar`, `rofi`, `alacritty`,
`dunst`, `picom-git`, `brightnessctl`, `xidlehook`, `scrot`,
`papirus-icon-theme`.
...
- **Inspect before use:** Ensure you review the configuration before applying
  it.
- **Backup:** Always create a backup of your current configuration before
  applying new dotfiles.
