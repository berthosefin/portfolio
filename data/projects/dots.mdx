---
  ...
  summary: Personal dotfiles for a customized setup, focused on simplicity, aesthetics, and efficiency.
  image: /images/dots.png
  role: 'Author'
  publishedAt: '2025-08-09'
  projectUrl: 'https://github.com/berthosefin/dots'
  liveUrl:
  tags: ['Hyprland', 'Linux', 'Rofi', 'Kitty', 'Wayland']
---
...
Personal dotfiles for a customized
[Hyprland](https://github.com/hyprwm/Hyprland) setup, focused on simplicity,
aesthetics, and efficiency.

> 🖌️ This configuration is based on [pywal](https://github.com/dylanaraps/pywal)
...
1. Deploy the Hyprland configuration using
